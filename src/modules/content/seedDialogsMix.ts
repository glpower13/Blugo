...
export const dialogs: Dialog[] = [
  ...
  // ── Ankommen: Zimmer, Frühstück, Mietwagen ────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'mh13', speaker: 'partner', sv: 'Tyvärr inte. Men bilen står klar på gården.', de: 'Leider nicht. Aber das Auto steht bereit im Hof.', decoding: [{ sv: 'tyvärr', de: 'leider' }, { sv: 'inte', de: 'nicht' }, { sv: 'men', de: 'aber' }, { sv: 'bilen', de: 'das Auto' }, { sv: 'står', de: 'steht' }, { sv: 'klar', de: 'fertig' }, { sv: 'på', de: 'auf' }, { sv: 'gården', de: 'dem Hof' }] },
  ...
  // ── Am Telefon: einladen, absagen, grüßen ─────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'mt9', speaker: 'partner', sv: 'Gärna! Fast hon reser bort på lördag.', de: 'Gern! Allerdings verreist sie am Samstag.', decoding: [{ sv: 'gärna', de: 'gern' }, { sv: 'fast', de: 'obwohl' }, { sv: 'hon', de: 'sie' }, { sv: 'reser', de: 'reist' }, { sv: 'bort', de: 'weg' }, { sv: 'på', de: 'am' }, { sv: 'lördag', de: 'Samstag' }] },
  ...
  // ── Sprache: buchstabieren, wörtlich, erzählen, Redewendung ───────────────
  {
    ...
    turns: [
      ...
      { id: 'msp11', speaker: 'partner', sv: 'Och sedan? Sammanfatta gärna i en mening.', de: 'Und dann? Fass es gern in einem Satz zusammen.', decoding: [{ sv: 'och', de: 'und' }, { sv: 'sedan', de: 'dann' }, { sv: 'sammanfatta', de: 'zusammenfassen' }, { sv: 'gärna', de: 'gern' }, { sv: 'i', de: 'in' }, { sv: 'en', de: 'einem' }, { sv: 'mening', de: 'Satz' }] },
      ...
      { id: 'msp15', speaker: 'partner', sv: 'Ha ha, den satt! Provet blev inställt tre gånger dock.', de: 'Ha ha, der saß! Der Test fiel allerdings dreimal aus.', decoding: [{ sv: 'ha', de: 'ha' }, { sv: 'ha', de: 'ha' }, { sv: 'den', de: 'der' }, { sv: 'satt', de: 'saß' }, { sv: 'provet', de: 'der Test' }, { sv: 'blev', de: 'wurde' }, { sv: 'inställt', de: 'abgesagt' }, { sv: 'tre', de: 'drei' }, { sv: 'gånger', de: 'Mal' }, { sv: 'dock', de: 'jedoch' }] },
  ...
  // ── Zeitung, Uhrzeit, gestern ─────────────────────────────────────────────
  {
    ...
    turns: [
      { id: 'mn1', speaker: 'partner', sv: 'Har du hört om bron? Alla pratar om den.', de: 'Hast du von der Brücke gehört? Alle reden davon.', listenFirst: true, decoding: [{ sv: 'har', de: 'hast' }, { sv: 'du', de: 'du' }, { sv: 'hört', de: 'gehört' }, { sv: 'om', de: 'über' }, { sv: 'bron', de: 'die Brücke' }, { sv: 'alla', de: 'alle' }, { sv: 'pratar', de: 'sprechen' }, { sv: 'om', de: 'über' }, { sv: 'den', de: 'sie' }] },
