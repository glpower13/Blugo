...
export const dialogs: Dialog[] = [
  ...
  // ── Erzählen & Zusammenfassen ─────────────────────────────────────────────
  {
    ...
    partnerName: 'Malin',
    turns: [
      { id: 'be1', speaker: 'partner', sv: 'Alla pratar om vad som hände på tåget. Var du med?', de: 'Alle reden davon, was im Zug passiert ist. Warst du dabei?', listenFirst: true, decoding: [{ sv: 'alla', de: 'alle' }, { sv: 'pratar', de: 'sprechen' }, { sv: 'om', de: 'über' }, { sv: 'vad', de: 'was' }, { sv: 'som', de: 'das' }, { sv: 'hände', de: 'geschah' }, { sv: 'på', de: 'auf' }, { sv: 'tåget', de: 'dem Zug' }, { sv: 'var', de: 'warst' }, { sv: 'du', de: 'du' }, { sv: 'med', de: 'dabei' }] },
  ...
  // ── Nuancen ───────────────────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'ny3', speaker: 'partner', sv: 'Okej. Så du tycker inte att förslaget är dåligt?', de: 'Okay. Du findest den Vorschlag also nicht schlecht?', decoding: [{ sv: 'okej', de: 'okay' }, { sv: 'så', de: 'also' }, { sv: 'du', de: 'du' }, { sv: 'tycker', de: 'meinst' }, { sv: 'inte', de: 'nicht' }, { sv: 'att', de: 'dass' }, { sv: 'förslaget', de: 'der Vorschlag' }, { sv: 'är', de: 'ist' }, { sv: 'dåligt', de: 'schlecht' }] },
