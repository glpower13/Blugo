...
const baseSegments: Segment[] = [
  ...
  { id: 's-hejda3', level: 1, sv: 'Hej då, ha det bra!', de: 'Tschüss, alles Gute!', decoding: [{ sv: 'hej', de: 'tschüss' }, { sv: 'då', de: 'dann' }, { sv: 'ha', de: 'hab' }, { sv: 'det', de: 'es' }, { sv: 'bra', de: 'gut' }], chunkIds: ['c-hejda', 'c-hadetbra'] },
  ...
  { id: 's-varsagod3', level: 1, sv: 'Varsågod, här är kvittot.', de: 'Bitte, hier ist der Beleg.', decoding: [{ sv: 'varsågod', de: 'bitte' }, { sv: 'här', de: 'hier' }, { sv: 'är', de: 'ist' }, { sv: 'kvittot', de: 'der Beleg' }], chunkIds: ['c-varsagod'] },
  ...
  { id: 's-daligtackning3', level: 1, sv: 'Jag har dålig täckning. Jag ringer dig senare.', de: 'Ich habe schlechten Empfang. Ich rufe dich später an.', decoding: [{ sv: 'jag', de: 'ich' }, { sv: 'har', de: 'habe' }, { sv: 'dålig', de: 'schlechten' }, { sv: 'täckning', de: 'Empfang' }, { sv: 'jag', de: 'ich' }, { sv: 'ringer', de: 'rufe an' }, { sv: 'dig', de: 'dich' }, { sv: 'senare', de: 'später' }], chunkIds: ['c-daligtackning', 'c-ringersenare'] },
  ...
  { id: 's-kontant3', level: 1, sv: 'Jag betalar kontant. Kan jag få kvittot?', de: 'Ich zahle bar. Kann ich den Beleg haben?', decoding: [{ sv: 'jag', de: 'ich' }, { sv: 'betalar', de: 'zahle' }, { sv: 'kontant', de: 'bar' }, { sv: 'kan', de: 'kann' }, { sv: 'jag', de: 'ich' }, { sv: 'få', de: 'bekommen' }, { sv: 'kvittot', de: 'den Beleg' }], chunkIds: ['c-kontant', 'c-kvitto'] },
  ...
  { id: 's-vilse3', level: 1, sv: 'Jag har gått vilse. Var är stationen?', de: 'Ich habe mich verlaufen. Wo ist der Bahnhof?', decoding: [{ sv: 'jag', de: 'ich' }, { sv: 'har', de: 'habe' }, { sv: 'gått', de: 'gegangen' }, { sv: 'vilse', de: 'irre' }, { sv: 'var', de: 'wo' }, { sv: 'är', de: 'ist' }, { sv: 'stationen', de: 'der Bahnhof' }], chunkIds: ['c-vilse'] },
  ...
  { id: 's-hoger3', level: 1, sv: 'Gå rakt fram och sväng till höger.', de: 'Geh geradeaus und bieg nach rechts ab.', decoding: [{ sv: 'gå', de: 'geh' }, { sv: 'rakt', de: 'gerade' }, { sv: 'fram', de: 'voran' }, { sv: 'och', de: 'und' }, { sv: 'sväng', de: 'bieg' }, { sv: 'till', de: 'nach' }, { sv: 'höger', de: 'rechts' }], chunkIds: ['c-hoger', 'c-raktfram'] },
  ...
  { id: 's-trevligt3', level: 1, sv: 'Jag heter Anna. Trevligt att träffas!', de: 'Ich heiße Anna. Schön, dich kennenzulernen!', decoding: [{ sv: 'jag', de: 'ich' }, { sv: 'heter', de: 'heiße' }, { sv: 'anna', de: 'Anna' }, { sv: 'trevligt', de: 'angenehm' }, { sv: 'att', de: 'zu' }, { sv: 'träffas', de: 'treffen' }], chunkIds: ['c-trevligt', 'c-heter'] },
