...
export const seedChunks: Chunk[] = [
  ...
  { id: 'c-lateskul', categoryId: 'cat-hangout', sv: 'det låter kul', de: 'das klingt lustig', decoding: [{ sv: 'det', de: 'das' }, { sv: 'låter', de: 'klingt' }, { sv: 'kul', de: 'lustig' }] },
  ...
  { id: 'c-vilkenbil', categoryId: 'cat-motor', sv: 'vilken bil!', de: 'was für ein Auto!', decoding: [{ sv: 'vilken', de: 'welches' }, { sv: 'bil', de: 'Auto' }] },
  ...
  { id: 'c-detregnar', categoryId: 'cat-nature', sv: 'det regnar', de: 'es regnet', decoding: [{ sv: 'det', de: 'es' }, { sv: 'regnar', de: 'regnet' }] },
...
export const seedSegments: Segment[] = [
  ...
  { id: 's-lateskul1', level: 1, sv: 'Det låter kul!', de: 'Das klingt lustig!', decoding: [{ sv: 'det', de: 'das' }, { sv: 'låter', de: 'klingt' }, { sv: 'kul', de: 'lustig' }], chunkIds: ['c-lateskul'] },
  { id: 's-lateskul2', level: 1, sv: 'Ja, det låter kul. Jag är med.', de: 'Ja, das klingt lustig. Ich bin dabei.', decoding: [{ sv: 'ja', de: 'ja' }, { sv: 'det', de: 'das' }, { sv: 'låter', de: 'klingt' }, { sv: 'kul', de: 'lustig' }, { sv: 'jag', de: 'ich' }, { sv: 'är', de: 'bin' }, { sv: 'med', de: 'mit' }], chunkIds: ['c-lateskul', 'c-jagarmed'] },
  ...
  { id: 's-startarinte2', level: 1, sv: 'Problemet är att bilen startar inte.', de: 'Das Problem ist, dass das Auto nicht anspringt.', decoding: [{ sv: 'problemet', de: 'das Problem' }, { sv: 'är', de: 'ist' }, { sv: 'att', de: 'dass' }, { sv: 'bilen', de: 'das Auto' }, { sv: 'startar', de: 'startet' }, { sv: 'inte', de: 'nicht' }], chunkIds: ['c-startarinte'] },
  ...
  { id: 's-vilkenbil1', level: 1, sv: 'Wow, vilken bil!', de: 'Wow, was für ein Auto!', decoding: [{ sv: 'wow', de: 'wow' }, { sv: 'vilken', de: 'welches' }, { sv: 'bil', de: 'Auto' }], chunkIds: ['c-vilkenbil'] },
  { id: 's-vilkenbil2', level: 1, sv: 'Vilken bil! Är den din?', de: 'Was für ein Auto! Ist das deins?', decoding: [{ sv: 'vilken', de: 'welches' }, { sv: 'bil', de: 'Auto' }, { sv: 'är', de: 'ist' }, { sv: 'den', de: 'das' }, { sv: 'din', de: 'deins' }], chunkIds: ['c-vilkenbil'] },
  ...
  { id: 's-lyckatill2', level: 1, sv: 'Vi ses, lycka till!', de: 'Bis dann, viel Erfolg!', decoding: [{ sv: 'vi', de: 'wir' }, { sv: 'ses', de: 'sehen uns' }, { sv: 'lycka till', de: 'viel Erfolg' }], chunkIds: ['c-lyckatill'] },
  ...
  { id: 's-heja2', level: 1, sv: 'Heja, heja!', de: 'Los, los!', decoding: [{ sv: 'heja', de: 'los' }], chunkIds: ['c-heja'] },
  ...
  { id: 's-springa2', level: 1, sv: 'Imorgon, ska vi springa?', de: 'Morgen, wollen wir laufen gehen?', decoding: [{ sv: 'imorgon', de: 'morgen' }, { sv: 'ska', de: 'sollen' }, { sv: 'vi', de: 'wir' }, { sv: 'springa', de: 'laufen' }], chunkIds: ['c-skavispringa'] },
  ...
  { id: 's-form2', level: 1, sv: 'Bra jobbat, du är i bra form.', de: 'Gut gemacht, du bist gut in Form.', decoding: [{ sv: 'bra', de: 'gut' }, { sv: 'jobbat', de: 'gearbeitet' }, { sv: 'du', de: 'du' }, { sv: 'är', de: 'bist' }, { sv: 'i', de: 'in' }, { sv: 'form', de: 'Form' }], chunkIds: ['c-braformad'] },
  ...
  { id: 's-vandra2', level: 1, sv: 'I helgen, ska vi vandra i skogen?', de: 'Am Wochenende, wollen wir im Wald wandern?', decoding: [{ sv: 'i', de: 'in' }, { sv: 'helgen', de: 'dem Wochenende' }, { sv: 'ska', de: 'sollen' }, { sv: 'vi', de: 'wir' }, { sv: 'vandra', de: 'wandern' }, { sv: 'skogen', de: 'dem Wald' }], chunkIds: ['c-vandra'] },
  ...
  { id: 's-regnar1', level: 1, sv: 'Det regnar.', de: 'Es regnet.', decoding: [{ sv: 'det', de: 'es' }, { sv: 'regnar', de: 'regnet' }], chunkIds: ['c-detregnar'] },
  { id: 's-regnar2', level: 1, sv: 'Tyvärr, det regnar idag.', de: 'Leider regnet es heute.', decoding: [{ sv: 'tyvärr', de: 'leider' }, { sv: 'det', de: 'es' }, { sv: 'regnar', de: 'regnet' }, { sv: 'idag', de: 'heute' }], chunkIds: ['c-detregnar'] },
