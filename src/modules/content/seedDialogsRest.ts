...
export const dialogs: Dialog[] = [
  // ── Begrüßen & Kennenlernen ───────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'hl5', speaker: 'partner', sv: 'Tack, riktigt fint. Och du då?', de: 'Danke, richtig gut. Und du?', decoding: [{ sv: 'tack', de: 'danke' }, { sv: 'riktigt', de: 'richtig' }, { sv: 'fint', de: 'fein' }, { sv: 'och', de: 'und' }, { sv: 'du', de: 'du' }, { sv: 'då', de: 'denn' }] },
  ...
  // ── Trainieren ────────────────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'tn7', speaker: 'partner', sv: 'Tack! Sista backen är kvar. Klarar du en till?', de: 'Danke! Der letzte Hügel fehlt noch. Schaffst du noch einen?', decoding: [{ sv: 'tack', de: 'danke' }, { sv: 'sista', de: 'letzte' }, { sv: 'backen', de: 'der Hügel' }, { sv: 'är', de: 'ist' }, { sv: 'kvar', de: 'übrig' }, { sv: 'klarar', de: 'schaffst' }, { sv: 'du', de: 'du' }, { sv: 'en', de: 'einen' }, { sv: 'till', de: 'noch' }] },
  ...
  // ── Wetter & Jahreszeiten ─────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'vr9', speaker: 'partner', sv: 'Klokt. Här inne är det åtminstone skönt.', de: 'Klug. Hier drinnen ist es wenigstens angenehm.', decoding: [{ sv: 'klokt', de: 'klug' }, { sv: 'här', de: 'hier' }, { sv: 'inne', de: 'drinnen' }, { sv: 'är', de: 'ist' }, { sv: 'det', de: 'es' }, { sv: 'åtminstone', de: 'wenigstens' }, { sv: 'skönt', de: 'angenehm' }] },
  ...
  // ── Wohnen & Zuhause ──────────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'bo3', speaker: 'partner', sv: 'Tack! Ljust och fint. Bor du ensam här?', de: 'Danke! Hell und schön. Wohnst du hier allein?', decoding: [{ sv: 'tack', de: 'danke' }, { sv: 'ljust', de: 'hell' }, { sv: 'och', de: 'und' }, { sv: 'fint', de: 'fein' }, { sv: 'bor', de: 'wohnst' }, { sv: 'du', de: 'du' }, { sv: 'ensam', de: 'allein' }, { sv: 'här', de: 'hier' }] },
