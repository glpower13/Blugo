...
export const dialogs: Dialog[] = [
  ...
  // ── Familie & Herkunft ────────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'fa7', speaker: 'partner', sv: 'Bor han också här, eller stannade han kvar?', de: 'Wohnt er auch hier, oder ist er geblieben?', decoding: [{ sv: 'bor', de: 'wohnt' }, { sv: 'han', de: 'er' }, { sv: 'också', de: 'auch' }, { sv: 'här', de: 'hier' }, { sv: 'eller', de: 'oder' }, { sv: 'stannade', de: 'blieb' }, { sv: 'han', de: 'er' }, { sv: 'kvar', de: 'übrig' }] },
