...
export const dialogs: Dialog[] = [
  // ── Bank & Geld ───────────────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'bk11', speaker: 'partner', sv: 'Konstigt. Prov igen och tryck in koden långsamt.', de: 'Seltsam. Versuch es noch mal und gib den Code langsam ein.', decoding: [{ sv: 'konstigt', de: 'seltsam' }, { sv: 'prov', de: 'versuche' }, { sv: 'igen', de: 'wieder' }, { sv: 'och', de: 'und' }, { sv: 'tryck', de: 'drücke' }, { sv: 'in', de: 'ein' }, { sv: 'koden', de: 'den Code' }, { sv: 'långsamt', de: 'langsam' }] },
  ...
  // ── Reise planen ──────────────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'rs9', speaker: 'partner', sv: 'En stuga vid vattnet. Min kusin hyr ut den.', de: 'Eine Hütte am Wasser. Mein Cousin vermietet sie.', decoding: [{ sv: 'en', de: 'eine' }, { sv: 'stuga', de: 'Hütte' }, { sv: 'vid', de: 'bei' }, { sv: 'vattnet', de: 'dem Wasser' }, { sv: 'min', de: 'mein' }, { sv: 'kusin', de: 'Cousin' }, { sv: 'hyr', de: 'vermietet' }, { sv: 'ut', de: 'aus' }, { sv: 'den', de: 'sie' }] },
  ...
  // ── Kinder & Schule ───────────────────────────────────────────────────────
  {
    ...
    turns: [
      ...
      { id: 'br3', speaker: 'partner', sv: 'Bara lite matte. Vi hade prov i går också.', de: 'Nur ein bisschen Mathe. Wir hatten gestern auch eine Arbeit.', decoding: [{ sv: 'bara', de: 'nur' }, { sv: 'lite', de: 'wenig' }, { sv: 'matte', de: 'Mathe' }, { sv: 'vi', de: 'wir' }, { sv: 'hade', de: 'hatten' }, { sv: 'prov', de: 'Prüfung' }, { sv: 'i', de: 'am' }, { sv: 'går', de: 'gestern' }, { sv: 'också', de: 'auch' }] },
      { id: 'br4', speaker: 'you', sv: 'hur gick provet?', de: 'wie lief die Arbeit?', chunkId: 'c-hurgickprovet', suggestions: ['Hur gick provet?', 'Vem är läraren?'] },
