...
- **Satz-Darstellung (Nutzerfrage 2026-07-23) — beraten in `gremium-darstellung.md`:** Empfehlung = **Zielsprache oben** (nicht Deutsch), **Bedeutung/Dekodierung bei NEUEM Chunk auto-offen** und bei bekanntem eingeklappt (Stütze verblasst → Testing-Effekt), **Produktion als Lücke im Kontext** (behebt zugleich den Spoiler, dass die Lösung oben steht). Noch **nicht gebaut** — Umsetzung offen. Offen: Schwelle „bekannt genug" zum Einklappen; Cloze bei mehreren Ziel-Chunks.
