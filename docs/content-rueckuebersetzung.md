...
- Geprüfte Zeilen (Wendungen · Segmente · Gesprächszeilen): **332**
- ❌ **A** Glossen-Lücken (hart): **0**
- ❌ **B** Kontext-Brüche (hart, Deckung < 0.5): **0**
- ℹ️ **B2** starke Kontextvariation (erwünscht): **9**
- ⚠️ **C** Glossen-Konflikte: **33** (davon bekannt kontextabhängig: 3)
- ⚠️ **D** mögliche Bedeutungsdrift: **23** (Deckung < 0.34)
...
| **där** | „dort" (Gespräch dlg-weg/w6) · „da" (Gespräch dlg-shop/g5) | — |
| **det** | „das" (Wendung c-kostar) · „es" (Wendung c-vilkendag) | — |
| **dig** | „dir" (Gespräch dlg-groceries/m1) · „dich" (Gespräch dlg-arzt/a11) | — |
...
| **sen** | „spät" (Segment s-forlat2) · „dann" (Gespräch dlg-weg/w4) | — |
...
| **vilken** | „welcher" (Wendung c-vilkendag) · „welche" (Wendung c-storlek) | — |
