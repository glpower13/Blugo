...
| **C** | **Erste vertikale Scheibe** der Pipeline: **eine** Fähigkeit (**Auto-Dekodierung SV→DE**) hinter dem Port, mit **einem** ersten Adapter | **R, T** | 🤖 + 🧑 | ✅ **gebaut 2026-07-23:** nutzerseitige KI-Auswahl + Login (`AiSettings.tsx`), Claude-Dekoder (`adapters/anthropic.ts`, BYOK), „Verbindung testen", **On-demand-„🤖 KI-Dekodierung" im Loop** (als „per KI" gekennzeichnet); 81 Tests + 3 E2E grün. **Offen:** KI-**Generierung** neuer Sätze, weitere Anbieter, verwalteter Schlüssel (Backend). |
